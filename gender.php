...
if (isset($_GET['kode_sepatu'])) {
    $gender = $_GET['kode_sepatu'];
    $shoes = getShoesByGender($gender);
}
if ($_GET['kode_sepatu'] == 'UNX11Y'){
    $zender = 'UNISEX';
}elseif ($_GET['kode_sepatu'] == 'BYO11Y'){
    $zender = 'PRIA';
}else{
    $zender = 'WANITA';
}
...
<div class="conta">
  <h1 class="kole"><?php echo $zender; ?></h1>
</div>
<div class="container-fluid" style="margin-bottom: 150px">
  <div class="row d-flex justify-content-center" style="width:100%;">
    <?php foreach ($shoes as $shoe): ?>
    <div class="col-lg-3 box">
        <img class="img-fluid" src="img/sepatu/<?php echo $shoe['Asset']; ?>" onclick="window.location='detail-beli.php?kode_sepatu=<?php echo $shoe['Nama_Produk']; ?>';">
